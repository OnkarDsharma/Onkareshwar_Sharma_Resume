...
// Retheme: palette swapped from the default blue/purple to the portfolio's
// green CRT terminal look (--primary #39ff88 accented with --secondary
// #ffb020), and motion tuned down to a slow, moody drift instead of a busy
// hero animation. Zero dependencies: one WebGL canvas that fills its parent.
// Drop it behind your content with
...
// Palette rebuilt from the site's CSS custom properties instead of the demo's
// blue/purple defaults:
//   --background #060907  --muted #101a14   --accent #123018
//   --primary #39ff88      --secondary #ffb020
// Reads as: black CRT glass -> dim terminal green -> full primary green ->
// a brief amber divergence flare at the peaks, echoing the site's
// primary/secondary accent pairing.
const UNIFORMS = {
  colors: [
    [0.0235, 0.0353, 0.0275], // --background
    [0.0627, 0.102, 0.0784],  // --muted
    [0.0706, 0.1882, 0.0941], // --accent
    [0.1216, 0.4157, 0.2196], // primary, dimmed
    [0.2235, 1.0, 0.5333],    // --primary
    [0.2235, 1.0, 0.5333],    // hold on primary a bit longer
    [1.0, 0.6902, 0.1255],    // --secondary flare
    [1.0, 0.6902, 0.1255],
  ...
  drift: 0.06,
  cursorEnabled: true,
  cursorEffect: 3.0, // ripple — fits the "divergence" theme
  cursorStrength: 0.28,
  cursorRadius: 0.55,
  oklab: 1.0, // perceptual mixing keeps the green mid-tones from muddying
  timeScale: 0.3, // slow, ambient drift instead of a busy hero animation
}
